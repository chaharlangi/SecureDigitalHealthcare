...
async function initializeValues(roomId, accessToken) {
  ...
  document
    .getElementById("user-access-token")
  ...
  //document.getElementById('acs-room-id').setAttribute("hidden", true);
  //document.getElementById('user-access-token').setAttribute("hidden", true);
}
//SIAVASH end
