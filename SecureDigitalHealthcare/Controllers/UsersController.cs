...
namespace SecureDigitalHealthcare.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(SecureDigitalHealthcareContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("NationalId,FirstName,LastName,Email,Password,Gender,Birthdate,Address,Phone")] User user)
        {
